function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis.parcelRequire917c,r=t.register;r("dysaJ",function(r,n){Object.defineProperty(r.exports,"__esModule",{value:!0,configurable:!0}),e(r.exports,"default",()=>t("39Pre").default),t("39Pre")}),r("39Pre",function(r,n){e(r.exports,"default",()=>d);var o=t("ayMG0"),i=t("acw62"),a=t("6pX2t");t("7mGZ8");var s=t("5O9lw");t("6o8v3");var l=t("bCBpA");t("9dJ6j");var c=t("6eDBx");t("kCony");var u=t("71Ftm");t("4MYRI");var p=t("cRe7k"),f=t("7QWJS");let m=()=>{let e=Object.keys(a.stratagems),t=e.length,r=0;for(;t>0;)r=Math.floor(Math.random()*t),t-=1,[e[t],e[r]]=[e[r],e[t]];let n=[];for(t=0;t<e.length;t+=8)n.push(e.slice(t,t+8));return n};var d=({onComplete:e})=>{let[t,r]=(0,i.useState)(0),n=(0,i.useRef)(m()),[d,g]=(0,i.useState)(0),_=(0,i.useMemo)(()=>n.current[d],[d]),[v,h]=(0,i.useState)(0),x=(0,i.useMemo)(()=>a.stratagems[_[v]],[_,v]),b=(0,i.useCallback)(()=>{t>+(localStorage.getItem("score")||0)&&localStorage.setItem("score",`${t}`),e(t)},[t]),S=(0,i.useCallback)(()=>{let e=v===_.length-1;d===n.current.length-1?e&&b():(e?(h(0),g(d+1)):h(v+1),(0,p.timer).emit("increase",20.664),r(e=>e+x.code.length))},[v,d,r]);return(0,o.jsxs)(f.Container,{children:[(0,o.jsx)(l.default,{currentRoundIndex:d}),(0,o.jsxs)(f.Stratagems,{children:[(0,o.jsx)(u.default,{currentRound:_,currentStratagem:x,currentStratagemIndex:v}),(0,o.jsx)(s.default,{code:x.code,onComplete:S}),(0,o.jsx)(p.default,{onDeplete:b})]}),(0,o.jsx)(c.default,{score:t})]})}}),r("7mGZ8",function(r,n){e(r.exports,"default",()=>t("5O9lw").default),t("5O9lw")}),r("5O9lw",function(r,n){e(r.exports,"default",()=>p);var o=t("ayMG0"),i=t("5hgdn"),a=t("acw62"),s=t("9Kx3T");t("k0Wop");var l=t("1ES3K"),c=t("7ocfk");let u=e=>(0,i.match)(e).returnType().with("arrowup",()=>"w").with("arrowright",()=>"d").with("arrowdown",()=>"s").with("arrowleft",()=>"a").otherwise(()=>e);var p=({code:e,onComplete:t})=>{let[r,n]=(0,a.useState)([]),[i,p]=(0,a.useState)(!1);return(0,s.useStratagemKey)(t=>{let o=u(t);e[r.length]===o?(n(r.concat(o)),p(!1)):(n([]),p(!0),setTimeout(()=>p(!1),500))},[r]),(0,a.useEffect)(()=>{r.join("")===e&&setTimeout(()=>{t(),n([])},66.4)},[r,e]),(0,o.jsx)(c.Code,{children:e.split("").map((e,t)=>(0,o.jsx)(c.Input,{"data-input":e,"data-valid":e===r[t]||void 0,"data-invalid":i||void 0,children:(0,o.jsx)(l.default,{})},`${e}-${t}`))})}}),r("k0Wop",function(r,n){e(r.exports,"default",()=>t("1ES3K").default),t("1ES3K")}),r("1ES3K",function(r,n){e(r.exports,"default",()=>a);var o=t("ayMG0"),i=t("cupWG"),a=()=>(0,o.jsx)(i.Arrow,{width:"62",height:"66",viewBox:"0 0 62 66",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,o.jsx)("path",{"fill-rule":"evenodd","clip-rule":"evenodd",d:"M0.715027 31.8015L31.6459 0.694458L61.707 31.8015V40.515H46.3713V65.9583H16.9198V40.515H0.71283V31.8015H0.715027Z",fill:"currentColor"})})}),r("cupWG",function(r,n){e(r.exports,"Arrow",()=>i);var o=t("lmFrL");let i=(0,o.styled).svg`
...
`,a=(0,o.styled).div`
  ...
  margin-bottom: 5%;
`});
//# sourceMappingURL=stratagems.3f31ca8c.js.map
